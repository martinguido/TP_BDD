...
//            Region region = new Region((Integer) (todasLasRegiones.get(i)).get("id"), (String) ((todasLasRegiones.get(i)).get("nombre")));
//            regionRepository.save(region);
            regionService.createRegion(new RegionDTO((Integer) (todasLasRegiones.get(i)).get("id"), (String) ((todasLasRegiones.get(i)).get("nombre"))));
        }
